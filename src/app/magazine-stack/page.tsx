    ...
    return (
        <>
            <style jsx global>{`
                ...
                .stack-slide {
                    animation: stack-slide 0.8s ease-out;
                }
                ...
                .magazine-layer:nth-child(1) { top: 0; z-index: 3; }
                .magazine-layer:nth-child(2) { top: 10px; z-index: 2; }
                .magazine-layer:nth-child(3) { top: 20px; z-index: 1; }
            `}</style>
                ...
                <section id="home" className="min-h-screen pt-20 px-4 md:px-8 bg-white">
                    <div className="magazine-grid items-center min-h-screen">
                        ...
                        <div className="span-8 z-10">
                            ...
                            {/* Creative Motto Expression - Magazine Style */}
                            <div className="magazine-stack">
                                <div className="magazine-layer bg-[#FF5BF1] p-6 text-white stack-slide">
                                    <h2 className="text-3xl md:text-4xl font-bold">WE CURATE THE</h2>
                                </div>
                                <div className="magazine-layer bg-[#EBF998] p-6 text-black stack-slide" style={{animationDelay: '0.3s'}}>
                                    <h2 className="text-4xl md:text-5xl font-black text-center">💖 HEART</h2>
                                </div>
                                <div className="magazine-layer bg-[#6370E7] p-6 text-white stack-slide" style={{animationDelay: '0.6s'}}>
                                    <h2 className="text-3xl md:text-4xl font-bold text-right">& 📰 HEADLINES</h2>
                                </div>
                            </div>
                            
                            <div className="mt-32 text-3xl md:text-4xl font-bold">
                                OF <span className="bg-black text-white px-4 py-2 inline-block transform skew-x-12">BRANDS</span>
                            </div>
                        ...
                        <div className="span-4 space-y-4 z-20">
                            ...
                            <div className="border-4 border-[#6370E7] p-6 bg-white">
                                <p className="font-bold text-lg">MAGAZINE STATUS:</p>
                                <p className="text-3xl mt-2">📚 STACKED</p>
                                <div className="mt-3 space-y-1">
                                    <div className="w-full bg-gray-200 h-2">
                                        <div className="bg-[#6370E7] h-2 w-full"></div>
                                    </div>
                                    <p className="text-xs text-right">100% Editorial Ready</p>
                                </div>
                            </div>
                    ...
                    <div className="max-w-7xl mx-auto">
                        <div className="bg-black text-white p-12 text-center transform -skew-y-1">
                            ...
                            <button className="px-8 py-4 bg-[#FF5BF1] text-white font-bold text-lg hover:bg-[#EBF998] hover:text-black transition">
                                SUBSCRIBE TO CURATIONSLA →</button>
                        </div>
                    </div>
                </section>
            </div>
