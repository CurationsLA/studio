    ...
    return (
        <div className="min-h-screen bg-[#FDFDFC]">
                    ...
                    <div className="max-w-7xl mx-auto w-full">
                        <div className="grid md:grid-cols-2 gap-8 items-center">
                            <div>
                                ...
                                <div className="mt-8">
                                    <div className="stepped-brutal bg-white text-black p-6">
                                    ...
                                    <div className="grid md:grid-cols-2 gap-4 mt-4">
                                        <a href="/creative-campaigns" className="stepped-brutal service-card bg-[#FF5BF1] text-white p-8">
                                        ...
                                        <a href="https://la.curations.org" target="_blank" rel="noopener noreferrer" className="stepped-brutal service-card bg-[#6370E7] text-white p-8">
                                            <h3 className="text-2xl md:text-4xl font-black text-center uppercase">
                                                [HEADLINES]
                                            </h3>
                                            <div className="mt-2 text-center text-sm font-bold">
                                ...
                                <div className="stepped-brutal campaign-showcase mt-4">
                                    ...
                                    <div className="space-y-3">
                                        <div className="bg-white bg-opacity-20 p-3">
                                            <div className="font-black text-sm">TACO TRUCK TAKEOVER</div>
                                            <div className="text-xs">2.3M TikTok Views</div>
                                        </div>
                                        <div className="bg-white bg-opacity-20 p-3">
                                            <div className="font-black text-sm">COFFEE COLLECTIVE</div>
                                            <div className="text-xs">500% UGC Increase</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div id="about" className="pt-0">
                <div className="bg-gradient-to-r from-[#FF5BF1] to-[#6370E7] text-white py-16 px-8">
                ...
                <div className="bg-[#FDFDFC] py-16 px-8">
                    <div className="max-w-7xl mx-auto">
                        <div className="stepped-brutal bg-[#4AE54A] p-8 mb-8">
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            <div className="stepped-brutal bg-[#FF5BF1] p-8">
                            ...
                            <div className="stepped-brutal bg-[#6370E7] p-8">
                ...
                <div className="bg-[#FDFDFC] py-16 px-8">
                    <div className="max-w-7xl mx-auto">
                        <div className="grid md:grid-cols-3 gap-8">
                            <a href="/restaurant-biz" className="stepped-brutal service-card bg-[#FF5BF1] text-white p-8">
                            ...
                            <a href="/ai-discovery" className="stepped-brutal service-card bg-[#6370E7] text-white p-8">
                            ...
                            <a href="/public-relations" className="stepped-brutal service-card bg-[#FF5BF1] text-white p-8">
                                <span className="text-5xl">📺</span>
                            ...
                            <a href="/creative-campaigns" className="stepped-brutal service-card bg-[#6370E7] text-white p-8">
                                <span className="text-5xl">🎨</span>
                            ...
                            <a href="/influencer-ugc" className="stepped-brutal service-card bg-[#4AE54A] text-black p-8">
                                <span className="text-5xl">🤝</span>
                            ...
                            <a href="/newsletter-services" className="stepped-brutal service-card bg-[#FF5BF1] text-white p-8">
                                <span className="text-5xl">📧</span>
            ...
            {/* Contact Section */}
            <div id="contact" className="pt-0 bg-gradient-to-r from-[#FF5BF1] to-[#6370E7] py-16 px-8">
                <div className="max-w-7xl mx-auto text-center">
                    ...
                    <div className="flex gap-4 justify-center flex-wrap">
                        <a href="mailto:curate@curations.org" className="stepped-brutal bg-white text-[#FF5BF1] px-8 py-4 font-black uppercase border-4 border-black cursor-pointer no-underline">
                            START YOUR CURATION
                        </a>
                        <a href="https://la.curations.org" target="_blank" rel="noopener noreferrer" className="stepped-brutal bg-[#4AE54A] text-black px-8 py-4 font-black uppercase border-4 border-black cursor-pointer no-underline">
                            SEE CURATIONSLA
                        </a>
                    </div>
                </div>
