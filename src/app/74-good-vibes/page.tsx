            ...
            <div className="bg-white text-black">
                    ...
                    <div className="magazine-grid items-center min-h-screen">
                        ...
                        <div className="span-8 z-10">
                            <div className="diagonal-text">
                                <h1 className="text-7xl md:text-[8.5rem] lg:text-[9.5rem] font-bold leading-none">
                            ...
                            <div className="span-12 bg-gradient-to-r from-[#FF5BF1] via-[#6370E7] to-[#EBF998] p-8 text-white brutal-box">
                                <div className="flex flex-wrap justify-between items-center">
                                    ...
                                    <div className="flex flex-wrap gap-3 mt-4 md:mt-0">
                                        <span className="bg-white/20 px-4 py-2">PAID SEARCH</span>
                                        <span className="bg-white/20 px-4 py-2">PAID SOCIAL</span>
                                        <span className="bg-white/20 px-4 py-2">DISPLAY ADS</span>
                                        <span className="bg-white/20 px-4 py-2">LINEAR TV</span>
                                        <span className="bg-white/20 px-4 py-2">EMAIL/CRM</span>
                                        <span className="bg-white/20 px-4 py-2">INFLUENCER</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className="mt-16 text-center py-10 bg-black">
                    <div className="inline-block brutal-box glass-effect p-8 border-2 border-[#EBF998]">
                        <p className="text-2xl font-bold text-[#EBF998] uppercase">🏆 GROW WITH GOOGLE PARTNER</p>
                ...
                <section className="py-20 px-8 relative bg-white">
                    <div className="max-w-7xl mx-auto">
                        <div className="text-center mb-16">
                            ...
                            <h2 className="text-6xl md:text-8xl font-bold">
                                <span className="text-pink-500">CURATIONS</span><span className="text-blue-500">LA</span>
                            </h2>
                        </div>
                        ...
                        <div className="relative h-[700px] md:h-[500px]">
                            ...
                            <div className="absolute top-20 left-0 w-full md:w-1/2 layer-2">
                                <div className="bg-[#FF8C00] p-8 glass-effect brutal-box">
                            ...
                            <div className="absolute top-40 right-0 w-full md:w-1/2 layer-3">
                                <div className="bg-gradient-to-br from-[#FF5BF1] to-[#6370E7] p-8 neon-glow-pink brutal-box">
                ...
                <section className="py-20 px-8 bg-black">
                    <div className="max-w-7xl mx-auto">
                        <div className="bg-black text-white p-12 text-center transform -skew-y-1">
                            <h3 className="text-4xl font-bold mb-4 text-white">Good Vibes 74</h3>
