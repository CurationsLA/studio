    ...
    return (
        <div style={{ fontFamily: "'JetBrains Mono', monospace", background: '#FDFDFC', minHeight: '100vh' }}>
            ...
            <style jsx global>{`
                ...
                .ai-workflow {
                    background: linear-gradient(135deg, #6370E7 0%, #FF5BF1 100%);
                    color: white;
                    padding: 2rem;
                    margin: 1rem 0;
                    position: relative;
                ...
                .roi-visualization {
                    background: linear-gradient(45deg, #FF5BF1, #6370E7, #EBF998);
                    padding: 2rem;
                    color: white;
                    text-align: center;
            ...
            {/* Hero Section */}
            <div style={{ background: 'linear-gradient(135deg, #6370E7 0%, #FF5BF1 100%)', padding: '4rem 2rem', color: 'white' }}>
            ...
            <div style={{ padding: '4rem 2rem', background: 'black' }}>
                <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
                    <h2 style={{ fontSize: '2.5rem', fontWeight: 800, textAlign: 'center', marginBottom: '2rem', textTransform: 'uppercase', color: '#00ff00' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(400px, 1fr))', gap: '2rem' }}>
                        <div>
                            <h3 style={{ color: '#00ff00', marginBottom: '1rem', textTransform: 'uppercase', fontWeight: 800 }}>
                                INPUT PROMPT:
                            </h3>
                            <div className="ai-terminal" style={{ minHeight: '150px' }}>
                                <div style={{ color: '#00ff00' }}>$ curations-ai --execute</div>
                        ...
                        <div>
                            ...
                            <div className="ai-terminal" style={{ minHeight: '150px' }}>
                                <div style={{ color: '#00ff00' }}>$ Processing...</div>
            ...
            {/* Investment Packages */}
            <div style={{ padding: '4rem 2rem', background: 'linear-gradient(135deg, #6370E7 0%, #FF5BF1 100%)' }}>
                <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
                    <h2 style={{ fontSize: '2.5rem', fontWeight: 800, textAlign: 'center', marginBottom: '3rem', textTransform: 'uppercase', color: 'white' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem' }}>
                        ...
                        <div className="brutal-box" style={{ background: 'black', color: '#00ff00', padding: '2rem', textAlign: 'center' }}>
                            <h3 style={{ fontSize: '1.5rem', fontWeight: 800, marginBottom: '1rem', textTransform: 'uppercase' }}>
                                AI ENTERPRISE
                            </h3>
            ...
            <div style={{ background: 'black', padding: '4rem 2rem', textAlign: 'center' }}>
                <h2 style={{ fontSize: '2.5rem', fontWeight: 800, color: '#00ff00', marginBottom: '2rem', textTransform: 'uppercase' }}>
