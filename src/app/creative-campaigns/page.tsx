    ...
    return (
        <div style={{ fontFamily: "'JetBrains Mono', monospace", background: '#FDFDFC', minHeight: '100vh' }}>
            ...
            <style jsx global>{`
                ...
                .creativity-fill {
                    height: 100%;
                    background: linear-gradient(90deg, #FF5BF1, #6370E7, #EBF998);
                ...
                .creative-card::before {
                    ...
                    width: 100%;
                    height: 100%;
                    background: linear-gradient(90deg, transparent, rgba(255, 91, 241, 0.1), transparent);
                ...
                .collaboration-showcase {
                    background: linear-gradient(45deg, #FF5BF1, #6370E7, #EBF998, #FF5BF1);
            ...
            {/* Hero Section */}
            <div style={{ background: 'linear-gradient(135deg, #FF5BF1 0%, #6370E7 50%, #EBF998 100%)', padding: '4rem 2rem', color: 'white' }}>
            ...
            <div style={{ padding: '4rem 2rem', background: '#FDFDFC' }}>
                <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
                    ...
                    <div className="creative-process">
                        ...
                        <div className="process-step">
                            <div className="step-icon" style={{ background: '#6370E7' }}>2</div>
                            <div>
                                <h3 style={{ fontSize: '1.5rem', fontWeight: 800, marginBottom: '0.5rem', textTransform: 'uppercase' }}>
                                    CREATIVE IDEATION
                                </h3>
                        ...
                        <div className="process-step">
                            <div className="step-icon" style={{ background: '#FF5BF1' }}>4</div>
                            <div>
                                <h3 style={{ fontSize: '1.5rem', fontWeight: 800, marginBottom: '0.5rem', textTransform: 'uppercase' }}>
                                    CULTURAL LAUNCH
                                </h3>
                        ...
                        <div className="process-step">
                            <div className="step-icon" style={{ background: '#6370E7' }}>5</div>
                            <div>
                                <h3 style={{ fontSize: '1.5rem', fontWeight: 800, marginBottom: '0.5rem', textTransform: 'uppercase' }}>
